...
lib.create = function (dir, file, data, callback) {
    ...
    fs.open(lib.base_dir + dir + slash + file + format.json_encoded, 'wx', function (err, fileDescriptor) {
...
lib.update = function (dir, file, data, callback) {
    //open the file for 
    fs.open(lib.base_dir + dir + slash + file + format.json_encoded, 'r+', function (err, fileDescriptor) {
        if (!err && fileDescriptor) {
            let string_data = JSON.stringify(data);
            //truncate the file
